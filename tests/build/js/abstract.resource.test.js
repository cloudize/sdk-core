const { MockRestClient, RestClient } = require('@apigames/rest-client');
const { ResourceContainer, ResourceObject } = require('../../../lib');
const { Order } = require('./customer.order.resource');
